...
Again, each metier is associated with a selectivity type and this is known a priori. All six selectivity types have their number of parameters; for the example below, all metiers have the same number of parameters but their selectivity type is either 2 or 6. For details on the selectivity types, consult the [BEMTOOL official guide](https://coispa.github.io/BEMTOOL_tutorial_SEAwiseWP6/BEMTOOL_tutorialMSE.html).
...
# -----------------------------------------------------
# Define selectivity parameters combinations per metier
# -----------------------------------------------------
