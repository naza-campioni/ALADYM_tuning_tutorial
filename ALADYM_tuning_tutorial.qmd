...
** ADD OVERVIEW, EXPLANATORY PICTURE **
...
**Stage 1**. In this stage the parameters that are varied are the recruitment time parameter _Tr_ and the age range over which fishing mortality is averaged, _Fbar_.
