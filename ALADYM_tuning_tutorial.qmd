...
Since the goal of the tuning process is to compare ALADYM outputs to stock assessment outputs, Fbar, SSB and catches `.csv` files need to be provided in the main ALADYM tuning folder (eg, `ALADYM-ver.Tuning`):

<a href="data/catches.csv" download>
Catches csv example
</a>

<a href="data/ssb.csv" download>
SSB csv example
</a>

<a href="data/fbar.csv" download>
Fbar csv example
</a>
